...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7965410651:AAGubHhRtJyvbj64z2zqRfwallmZuO83alE") 
    ...
    START_PIC   = os.environ.get("START_PIC", "https://ibb.co/tpM6HnyB")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '7845335174').split()]
    # -- FORCE_SUB_CHANNELS = ["BotzPW","AshuSupport","AshutoshGoswami24"] -- # 
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'ANIELITETELUGU').split(',')
...
<b>Bot Is Made By @ROHITREDDY69</b>

<b><a href='https://github.com/ROHIT12-bit/AUTORENAMER'>AshutoshGoswami24/Auto-Rename-Bot.git</a></b>
"""
...
<b>➻ Example :</b> <code> /autorename Naruto Shippuden S01[episode] [quality][Dual Audio] @ROHITREDDY69</code>
...
<b>♻️ Bot Made By :</b> @ROHITREDDY69"""
